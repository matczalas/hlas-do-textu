...
PODCAST_ACCENT = "#7C3AED"          # Violet — rozhovory & podcasty (kreativní obsah)
PODCAST_ACCENT_STRONG = "#6D28D9"
PODCAST_ACCENT_PRESS = "#5B21B6"

HR_ACCENT = "#BE185D"               # Magenta — HR & nábor (lidé)
HR_ACCENT_STRONG = "#9D174D"
HR_ACCENT_PRESS = "#831843"

COACH_ACCENT = "#15803D"            # Zelená — kouč (růst, rozvoj)
COACH_ACCENT_STRONG = "#166534"
COACH_ACCENT_PRESS = "#14532D"

SPOLEK_ACCENT = "#4338CA"           # Indigo — spolky & SVJ (formální, úřední)
SPOLEK_ACCENT_STRONG = "#3730A3"
SPOLEK_ACCENT_PRESS = "#312E81"
...
PODCAST = RoleTokens("podcast", PODCAST_ACCENT, PODCAST_ACCENT_STRONG, PODCAST_ACCENT_PRESS)
HR = RoleTokens("hr", HR_ACCENT, HR_ACCENT_STRONG, HR_ACCENT_PRESS)
COACH = RoleTokens("coach", COACH_ACCENT, COACH_ACCENT_STRONG, COACH_ACCENT_PRESS)
SPOLEK = RoleTokens("spolek", SPOLEK_ACCENT, SPOLEK_ACCENT_STRONG, SPOLEK_ACCENT_PRESS)

_ROLES_BY_KEY: dict[str, RoleTokens] = {
    r.name: r for r in (STUDENT, TEACHER, SALES, PODCAST, HR, COACH, SPOLEK)
}
...
def set_role(role: str) -> None:
    """Přepne aktivní roli (klíč z _ROLES_BY_KEY; neznámý klíč → student).
    Po volání znovu aplikuj paletu i stylesheet (viz apply_theme v theme.py)."""
    global _active_role
    _active_role = _ROLES_BY_KEY.get(role, STUDENT)
